...
class MapServices {
  ...
  void goToNewLocation({
    ...
    LatLng newCameraPosition = LatLng(latitude, longitude);
    googleMapController.animateCamera(
      CameraUpdate.newLatLng(newCameraPosition),
    );
  }
  ...
  void updateCurrentLocation(
    ...
    locationService.getRealTimeLocationData((locationData) {
      ...
      CameraPosition myCurrentCameraPoistion = CameraPosition(
        target: newLocation ?? currentLocation!,
        zoom: 17,
      );
      googleMapController.animateCamera(
